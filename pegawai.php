...
<div class="container">
  ...
  <form class="form-horizontal" style="margin-top:10%;" action="upload.php" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-9">
        <input type="number" class="form-control" id="hp" name="hp" placeholder="Enter number" required="required">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="alamat">Alamat:</label>
      <div class="col-sm-9">
        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Enter text" required="required">
      </div>
    </div>
    <div class="form-group"> 
